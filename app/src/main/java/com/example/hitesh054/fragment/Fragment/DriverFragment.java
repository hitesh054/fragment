...
public class DriverFragment extends Fragment implements View.OnClickListener, ResultResponse {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View myView = inflater.inflate(R.layout.fragment_driver, container, false);
        // Session Manager
...
//                        // Use user real data
                        session.createLoginSession("Android Hive", "anroidhive@gmail.com","driver1");
//
//                        // Staring MainActivity
//                        Intent i = new Intent(getActivity(), driver_Activity.class);
//                        startActivity(i);
//
//                        getActivity().finish();
//                    }else{
